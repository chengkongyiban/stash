        ...
        !(async () => {
            ...
            if (body == null || body == "") {
                ...
                body.forEach((x, y, z) => {
                    ...
                    if (type) {
                        switch (type) {
                            ...
                            case " reject":
                                ...
                                if (x.search(/ reject(-200|-img|-dict|-array|-video)?$/i) == -1) {} else if (isLooniOS) {
                                ...
                                if (type.match(/ 302|307|header/)) {
                                    ...
                                    if (isLooniOS) {
                                        ...
                                        if (x.match(/^#?(DOM|USER|URL|IP|GEO)[^,]+,[^,]+$/i) || x.match(/proxy$/i)) {
                                            ...
                                            rules.push(x.replace(/, *REJECT.*/i, ",REJECT"));
                                        };
                                        ...
                                        } else if (x.match(/^#?(DOM|USER|URL|IP|GEO)[^,]+,[^,]+$/i) || x.match(/proxy$/i)) {
                                            x = "";
                    ...
                    if (isStashiOS || isSurgeiOS) {
                        others != "" && $notification.post("不支持的类型已跳过", others, "点击查看原文，长按可展开查看剩余不支持内容", {
                            url: req
                        });
                    } else if (isLooniOS || isShadowrocket) {
